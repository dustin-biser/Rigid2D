...
\label{class_gnuplot_a8ceac5808e42665c1dee305ae7ea9070}

\begin{DoxyCompactList}\small\item\em plot a single std::vector at one go \item\end{DoxyCompactList}\item 
\hypertarget{class_gnuplot_a24327b6116c71acdc195eadf665c67cb}{
...
\label{class_gnuplot_a24327b6116c71acdc195eadf665c67cb}
...
\begin{DoxyCompactList}\small\item\em Sends a command to an active gnuplot session, identical to \hyperlink{class_gnuplot_a07607803ede8dd5416906df0a1924fc5}{cmd()} send a command to gnuplot using the $<$$<$ operator. \item\end{DoxyCompactList}\item 
\hypertarget{class_gnuplot_a356d2faaa79f08d13fec9718b776b28d}{
\hyperlink{class_gnuplot}{Gnuplot} \& \hyperlink{class_gnuplot_a356d2faaa79f08d13fec9718b776b28d}{showonscreen} ()}
\label{class_gnuplot_a356d2faaa79f08d13fec9718b776b28d}

\begin{DoxyCompactList}\small\item\em sets terminal type to terminal\_\-std \item\end{DoxyCompactList}\item 
\hypertarget{class_gnuplot_a032072c7c01b508a7535a17fb08562b1}{
...
\label{class_gnuplot_a032072c7c01b508a7535a17fb08562b1}
...
\item 
\hypertarget{class_gnuplot_a671cbe7b18a267ea59f532c83a0035f6}{
...
\label{class_gnuplot_a671cbe7b18a267ea59f532c83a0035f6}
...
\hypertarget{class_gnuplot_ab810fa4c02fb49ae197786c305b78702}{
...
\label{class_gnuplot_ab810fa4c02fb49ae197786c305b78702}
...
\hypertarget{class_gnuplot_afcb311938827f8718f19ed52d66bad7c}{
...
\label{class_gnuplot_afcb311938827f8718f19ed52d66bad7c}

\begin{DoxyCompactList}\small\item\em set x axis label \item\end{DoxyCompactList}\item 
\hypertarget{class_gnuplot_aa93589a95aeab869ba731e2583843ae4}{
...
\label{class_gnuplot_aa93589a95aeab869ba731e2583843ae4}

\begin{DoxyCompactList}\small\item\em set y axis label \item\end{DoxyCompactList}\item 
\hypertarget{class_gnuplot_ab3206e715d20f05cc0dd1eec89ce8b07}{
...
\label{class_gnuplot_ab3206e715d20f05cc0dd1eec89ce8b07}

\begin{DoxyCompactList}\small\item\em set z axis label \item\end{DoxyCompactList}\item 
\hypertarget{class_gnuplot_a4b8d96018f2d2d4e2922d4df153d6a84}{
\hyperlink{class_gnuplot}{Gnuplot} \& \hyperlink{class_gnuplot_a4b8d96018f2d2d4e2922d4df153d6a84}{set\_\-xrange} (const double iFrom, const double iTo)}
\label{class_gnuplot_a4b8d96018f2d2d4e2922d4df153d6a84}

\begin{DoxyCompactList}\small\item\em set axis -\/ ranges \item\end{DoxyCompactList}\item 
\hypertarget{class_gnuplot_a461271b7bfd4f84bdfc0055457226f28}{
\hyperlink{class_gnuplot}{Gnuplot} \& \hyperlink{class_gnuplot_a461271b7bfd4f84bdfc0055457226f28}{set\_\-yrange} (const double iFrom, const double iTo)}
\label{class_gnuplot_a461271b7bfd4f84bdfc0055457226f28}

\begin{DoxyCompactList}\small\item\em set y-\/axis -\/ ranges \item\end{DoxyCompactList}\item 
\hypertarget{class_gnuplot_a7273f6a48024117b4d234d0251106e78}{
\hyperlink{class_gnuplot}{Gnuplot} \& \hyperlink{class_gnuplot_a7273f6a48024117b4d234d0251106e78}{set\_\-zrange} (const double iFrom, const double iTo)}
\label{class_gnuplot_a7273f6a48024117b4d234d0251106e78}
...
\item 
\hypertarget{class_gnuplot_aff546fad227d93babeb5d2cc9f047b89}{
...
\label{class_gnuplot_aff546fad227d93babeb5d2cc9f047b89}
...
\hypertarget{class_gnuplot_a201a802d2f27fece0d39809c4eb3bce0}{
...
\label{class_gnuplot_a201a802d2f27fece0d39809c4eb3bce0}
...
\hypertarget{class_gnuplot_a1da3838163b0dbde8809b55c5b5c56b1}{
...
\label{class_gnuplot_a1da3838163b0dbde8809b55c5b5c56b1}
...
\item 
\hypertarget{class_gnuplot_a2228f5ab4cce2da463fc90383076a598}{
\hyperlink{class_gnuplot}{Gnuplot} \& \hyperlink{class_gnuplot_a2228f5ab4cce2da463fc90383076a598}{set\_\-cbrange} (const double iFrom, const double iTo)}
\label{class_gnuplot_a2228f5ab4cce2da463fc90383076a598}
...
\item 
\hyperlink{class_gnuplot}{Gnuplot} \& \hyperlink{class_gnuplot_aae22c0470a6fbbc1f5e84dec8d023381}{plot\_\-image} (const unsigned char $\ast$ucPicBuf, const unsigned int iWidth, const unsigned int iHeight, const std::string \&title=\char`\"{}\char`\"{})
...
\hypertarget{class_gnuplot_a6797761712d3c311e3685bcccba65dd4}{
\hyperlink{class_gnuplot}{Gnuplot} \& \hyperlink{class_gnuplot_a6797761712d3c311e3685bcccba65dd4}{reset\_\-plot} ()}
\label{class_gnuplot_a6797761712d3c311e3685bcccba65dd4}
...
\hypertarget{class_gnuplot_a9aedfe8371083a1a3ac2b9493810049c}{
\hyperlink{class_gnuplot}{Gnuplot} \& \hyperlink{class_gnuplot_a9aedfe8371083a1a3ac2b9493810049c}{reset\_\-all} ()}
\label{class_gnuplot_a9aedfe8371083a1a3ac2b9493810049c}
...
\subsubsection[{is\_\-valid}]{\setlength{\rightskip}{0pt plus 5cm}bool Gnuplot::is\_\-valid ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\end{DoxyReturn}
\hypertarget{class_gnuplot_afb69631c7a498077e378a3cbb56f38c8}{
\index{Gnuplot@{Gnuplot}!operator$<$$<$@{operator$<$$<$}}
\index{operator$<$$<$@{operator$<$$<$}!Gnuplot@{Gnuplot}}
\subsubsection[{operator$<$$<$}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::operator$<$$<$ (const std::string \& {\em cmdstr})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
\label{class_gnuplot_afb69631c7a498077e378a3cbb56f38c8}
...
\end{DoxyReturn}
\hypertarget{class_gnuplot_a42dfb8c9d4636745c7be277ed818e849}{
\index{Gnuplot@{Gnuplot}!plot\_\-equation@{plot\_\-equation}}
\index{plot\_\-equation@{plot\_\-equation}!Gnuplot@{Gnuplot}}
\subsubsection[{plot\_\-equation}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot} \& Gnuplot::plot\_\-equation (const std::string \& {\em equation}, \/  const std::string \& {\em title} = {\ttfamily \char`\"{}\char`\"{}})}}
...
\subsubsection[{plot\_\-equation3d}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot} \& Gnuplot::plot\_\-equation3d (const std::string \& {\em equation}, \/  const std::string \& {\em title} = {\ttfamily \char`\"{}\char`\"{}})}}
\label{class_gnuplot_a79aed3a6927f7d1d3497cba441e8a943}
plot an equation supplied as a std::string z=f(x,y), write only the function f(x,y) not z= the independent variables have to be x and y \hypertarget{class_gnuplot_aae22c0470a6fbbc1f5e84dec8d023381}{
\index{Gnuplot@{Gnuplot}!plot\_\-image@{plot\_\-image}}
\index{plot\_\-image@{plot\_\-image}!Gnuplot@{Gnuplot}}
\subsubsection[{plot\_\-image}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot} \& Gnuplot::plot\_\-image (const unsigned char $\ast$ {\em ucPicBuf}, \/  const unsigned int {\em iWidth}, \/  const unsigned int {\em iHeight}, \/  const std::string \& {\em title} = {\ttfamily \char`\"{}\char`\"{}})}}
\label{class_gnuplot_aae22c0470a6fbbc1f5e84dec8d023381}


plot image 

$\ast$ note that this function is not valid for versions of GNUPlot below 4.2 \hypertarget{class_gnuplot_aa00fcd4061a34332f8695276527b9f61}{
\index{Gnuplot@{Gnuplot}!plot\_\-x@{plot\_\-x}}
\index{plot\_\-x@{plot\_\-x}!Gnuplot@{Gnuplot}}
\subsubsection[{plot\_\-x}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename X $>$ {\bf Gnuplot} \& Gnuplot::plot\_\-x (const X \& {\em x}, \/  const std::string \& {\em title} = {\ttfamily \char`\"{}\char`\"{}})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
\label{class_gnuplot_aa00fcd4061a34332f8695276527b9f61}


from std::vector 

Plots a 2d graph from a list of doubles: x. \hypertarget{class_gnuplot_a2a7ded45a0d9bd6f6149866810540c5a}{
\index{Gnuplot@{Gnuplot}!plot\_\-xy@{plot\_\-xy}}
\index{plot\_\-xy@{plot\_\-xy}!Gnuplot@{Gnuplot}}
\subsubsection[{plot\_\-xy}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename X , typename Y $>$ {\bf Gnuplot} \& Gnuplot::plot\_\-xy (const X \& {\em x}, \/  const Y \& {\em y}, \/  const std::string \& {\em title} = {\ttfamily \char`\"{}\char`\"{}})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
\label{class_gnuplot_a2a7ded45a0d9bd6f6149866810540c5a}
...
\subsubsection[{plot\_\-xy\_\-err}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename X , typename Y , typename E $>$ {\bf Gnuplot} \& Gnuplot::plot\_\-xy\_\-err (const X \& {\em x}, \/  const Y \& {\em y}, \/  const E \& {\em dy}, \/  const std::string \& {\em title} = {\ttfamily \char`\"{}\char`\"{}})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
plot x,y pairs with dy errorbars \hypertarget{class_gnuplot_a4fc34218cdfdd27a65b92eea1f1f9e84}{
\index{Gnuplot@{Gnuplot}!plotfile\_\-x@{plotfile\_\-x}}
\index{plotfile\_\-x@{plotfile\_\-x}!Gnuplot@{Gnuplot}}
\subsubsection[{plotfile\_\-x}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot} \& Gnuplot::plotfile\_\-x (const std::string \& {\em filename}, \/  const unsigned int {\em column} = {\ttfamily 1}, \/  const std::string \& {\em title} = {\ttfamily \char`\"{}\char`\"{}})}}
...
\subsubsection[{plotfile\_\-xy}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot} \& Gnuplot::plotfile\_\-xy (const std::string \& {\em filename}, \/  const unsigned int {\em column\_\-x} = {\ttfamily 1}, \/  const unsigned int {\em column\_\-y} = {\ttfamily 2}, \/  const std::string \& {\em title} = {\ttfamily \char`\"{}\char`\"{}})}}
...
\subsubsection[{plotfile\_\-xy\_\-err}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot} \& Gnuplot::plotfile\_\-xy\_\-err (const std::string \& {\em filename}, \/  const unsigned int {\em column\_\-x} = {\ttfamily 1}, \/  const unsigned int {\em column\_\-y} = {\ttfamily 2}, \/  const unsigned int {\em column\_\-dy} = {\ttfamily 3}, \/  const std::string \& {\em title} = {\ttfamily \char`\"{}\char`\"{}})}}
...
\subsubsection[{plotfile\_\-xyz}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot} \& Gnuplot::plotfile\_\-xyz (const std::string \& {\em filename}, \/  const unsigned int {\em column\_\-x} = {\ttfamily 1}, \/  const unsigned int {\em column\_\-y} = {\ttfamily 2}, \/  const unsigned int {\em column\_\-z} = {\ttfamily 3}, \/  const std::string \& {\em title} = {\ttfamily \char`\"{}\char`\"{}})}}
...
\subsubsection[{replot}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::replot (void)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{set\_\-contour}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot} \& Gnuplot::set\_\-contour (const std::string \& {\em position} = {\ttfamily \char`\"{}base\char`\"{}})}}
...
\subsubsection[{set\_\-GNUPlotPath}]{\setlength{\rightskip}{0pt plus 5cm}bool Gnuplot::set\_\-GNUPlotPath (const std::string \& {\em path})\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\subsubsection[{set\_\-hidden3d}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::set\_\-hidden3d ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{set\_\-legend}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot} \& Gnuplot::set\_\-legend (const std::string \& {\em position} = {\ttfamily \char`\"{}default\char`\"{}})}}
...
\subsubsection[{set\_\-multiplot}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::set\_\-multiplot ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{set\_\-smooth}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot} \& Gnuplot::set\_\-smooth (const std::string \& {\em stylestr} = {\ttfamily \char`\"{}csplines\char`\"{}})}}
...
\subsubsection[{set\_\-style}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot} \& Gnuplot::set\_\-style (const std::string \& {\em stylestr} = {\ttfamily \char`\"{}points\char`\"{}})}}
...
\subsubsection[{set\_\-surface}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::set\_\-surface ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{set\_\-terminal\_\-std}]{\setlength{\rightskip}{0pt plus 5cm}void Gnuplot::set\_\-terminal\_\-std (const std::string \& {\em type})\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\subsubsection[{set\_\-title}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::set\_\-title (const std::string \& {\em title} = {\ttfamily \char`\"{}\char`\"{}})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{set\_\-xautoscale}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::set\_\-xautoscale ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{set\_\-yautoscale}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::set\_\-yautoscale ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{set\_\-zautoscale}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::set\_\-zautoscale ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{unset\_\-contour}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::unset\_\-contour ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{unset\_\-hidden3d}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::unset\_\-hidden3d ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{unset\_\-legend}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::unset\_\-legend ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{unset\_\-multiplot}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::unset\_\-multiplot ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{unset\_\-smooth}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::unset\_\-smooth ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{unset\_\-surface}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::unset\_\-surface ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{unset\_\-title}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::unset\_\-title ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{unset\_\-xlogscale}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::unset\_\-xlogscale ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{unset\_\-ylogscale}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::unset\_\-ylogscale ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{unset\_\-zlogscale}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Gnuplot}\& Gnuplot::unset\_\-zlogscale ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
